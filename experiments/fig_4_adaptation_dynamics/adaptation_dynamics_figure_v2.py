...
def create_figure(losses_data, fidelity_data, pulse_data, K_adapt, save_path=None):
    ...
    colors_init = ['#2E86AB', '#E94F37', '#8E8E8E']  # FOMAML=blue, Fixed=red, Random=gray
    ...
    all_fids = fidelity_data['robust'] + fidelity_data['meta_init'] + fidelity_data['adapted']
...
def main():
    ...
    parser.add_argument('--checkpoint', type=str,
                        default='../../checkpoints/checkpoints_gamma/maml_gamma_pauli_x.pt',
                        help='Path to gamma checkpoint (V1 - shows clearer adaptation dynamics)')
    parser.add_argument('--output', type=str, default='adaptation_dynamics_v2',
    ...
    parser.add_argument('--K_adapt', type=int, default=20, help='Adaptation steps for panels (b) and (c)')
    parser.add_argument('--inner_lr', type=float, default=0.01, help='Inner learning rate (SGD)')
    parser.add_argument('--ood_gamma_deph', type=float, default=0.35,
                        help='Challenging gamma_deph (training max=0.15)')
    parser.add_argument('--ood_gamma_relax', type=float, default=0.15,
                        help='Challenging gamma_relax (training max=0.08)')
